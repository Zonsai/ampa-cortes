...
{
    protected static string $relationship = 'consentResponses';

    protected static ?string $title = 'Consentimientos';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('consentType.name')
            ...
            ->recordActions([
                Action::make('ver_historial')
                    ...
                    ->modalHeading(fn (ConsentResponse $record): string => "Historial — {$record->consentType->name}")
