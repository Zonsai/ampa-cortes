...
class AcademicYearResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Cursos escolares';

    protected static ?string $modelLabel = 'Curso escolar';

    protected static ?string $pluralModelLabel = 'Cursos escolares';
