...
class ClassroomResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Clases/grupos';

    protected static ?string $modelLabel = 'Clase/grupo';

    protected static ?string $pluralModelLabel = 'Clases/grupos';
